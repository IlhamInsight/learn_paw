<div class="tambah-jurusan">
    ...
    <form class="admin" method="post">
        <div class="masukan-jurusan">
            <label for="name-kebutuhan">Nama Kebutuhan</label>
            <input type="text" name="nama-kebutuhan" id="name-kebutuhan" value="<?php echo htmlspecialchars($_POST['nama-kebutuhan'] ?? ''); ?>">
        </div>
        <?php
        ...
        <div class="desk-jurusan">
            ...
            <input type="text" name="desk-kebutuhan" id="desk-kebutuhan" value="<?php echo htmlspecialchars(trim($_POST['desk-kebutuhan'] ?? '')); ?>">
        </div>
        <?php
