        ...
        <form class="admin" method="post">
            <div class="masukan-jurusan">
                ...
                <input type="text" name="masukan-jurusan" id="masukan-jurusan"
                    value="<?= htmlspecialchars(trim($_POST['masukan-jurusan'] ?? $data_edit['NAMA_JURUSAN'] ?? '')); ?>"><br>
            </div>
            <?php
            ...
            <div class="desk-jurusan">
                ...
                <input type="text" name="desk-jurusan" id="desk-jurusan"
                    value="<?= htmlspecialchars(trim($_POST['desk-jurusan'] ?? $data_edit['DESKRIPSI_JURUSAN'] ?? '')); ?>"><br>

            </div>
            <?php
            if (isset($errors['desk-jurusan'])) {
                echo "<p class='erorr'>{$errors['desk-jurusan']}</p>";
            } elseif (isset($errors['jurusanss'])) {
                echo "<p class='erorr'>{$errors['jurusanss']}</p>";
            }
