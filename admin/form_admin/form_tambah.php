    <div class="tambah-jurusan">    
        ...
        <form class="admin" method="post">
            <div class="masukan-jurusan">
                ...
                <input type="text" name="masukan-jurusan" id="masukan-jurusan" value="<?= htmlspecialchars($_POST['masukan-jurusan'] ?? ''); ?>">
            </div>    
            <?php 
            ...
            <div class="desk-jurusan">
                ...
                <input type="text" name="desk-jurusan" id="desk-jurusan" value="<?= htmlspecialchars(trim($_POST['desk-jurusan'] ?? '')); ?>">
            </div>
            <?php 
