<div class="tambah-jurusan">
    ...
    <form class="admin" method="post">
        <div class="masukan-jurusan">
            ...
            <input type="text" name="nama-kebutuhan" id="nama-kebutuhan" value="<?php echo htmlspecialchars($_POST['nama-kebutuhan'] ?? $data_edit_kebutuhan['NAMA_KEBUTUHAN'] ?? ''); ?>">
        </div>
        <?php
        ...
        <div class="desk-jurusan">
            ...
            <input type="text" name="desk-kebutuhan" id="desk-kebutuhan" value="<?php echo htmlspecialchars(trim($_POST['desk-kebutuhan'] ?? $data_edit_kebutuhan['DESKRIPSI_KEBUTUHAN'] ?? '')); ?>">
        </div>
        <?php
