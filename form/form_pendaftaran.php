<form class="pendaftaran" method="POST" enctype="multipart/form-data">
    <div class="data-reg">
        <label>Nama Lengkap</label>
        <span class="value"><?= htmlspecialchars($data_siswa['NAMA_LENGKAP'] ?? ''); ?></span>
    </div>
    ...
    <div class="data-reg">
        <label>Pilihan Satu *</label>
        <select name="jurusan-satu">
    ...
    <div class="data-reg">
        <label for="file_ijazah">Masukkan Ijazah (Jpg/Jpeg/Pdf) *</label>
