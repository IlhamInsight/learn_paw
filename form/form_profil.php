...
<form class="profil-siswa" method="POST" enctype="multipart/form-data">

    <div class="data-profil">
        <label for="nama_lengkap">Nama Lengkap *</label>
        <input type="text" name="nama_lengkap" id="nama_lengkap" value="<?= htmlspecialchars($_POST['nama_lengkap'] ?? $data_siswa['NAMA_LENGKAP'] ?? ''); ?>">
        <?php
    ...
    <div class="username">
        ...
        <span class="value"><?= htmlspecialchars($data_siswa['USER_SISWA'] ?? ''); ?></span>
    </div>
    ...
    <div class="data-profil">
        ...
        <input type="text" name="tempat_lahir" id="tempat_lahir" value="<?= htmlspecialchars($_POST['tempat_lahir'] ?? $data_siswa['TEMPAT_LAHIR'] ?? ''); ?>">
        <?php
    ...
    <div class="data-profil">
        ...
        <input type="text" name="tgl_lahir" id="tgl_lahir" placeholder="dd-mm-yyyy" value="<?= htmlspecialchars($_POST['tgl_lahir'] ?? $tgl_value ?? ''); ?>">
        <?php
    ...
    <div class="data-profil">
        ...
        <div class="radio-group">
            <input type="radio" id="laki_laki" name="jenis_kelamin" value="Laki-laki" <?php if (($_POST['jenis_kelamin'] ?? $data_siswa['JENIS_KELAMIN'] ?? '') == 'Laki-laki') {
                                                                                            echo 'checked';
                                                                                        } ?>>
            <label for="laki_laki">Laki-laki</label>

            <input type="radio" id="perempuan" name="jenis_kelamin" value="Perempuan" <?php if (($_POST['jenis_kelamin'] ?? $data_siswa['JENIS_KELAMIN'] ?? '') == 'Perempuan') {
                                                                                            echo 'checked';
                                                                                        } ?>>
    ...
    <div class="data-profil">
        ...
        <textarea name="alamat" id="alamat" rows="4"><?= htmlspecialchars($_POST['alamat'] ?? $data_siswa['ALAMAT'] ?? ''); ?></textarea>
        <?php
    ...
    <div class="data-profil">
        ...
        <input type="text" name="asal_sekolah" id="asal_sekolah" value="<?= htmlspecialchars($_POST['asal_sekolah'] ?? $data_siswa['ASAL_SEKOLAH'] ?? ''); ?>">
        <?php
    ...
    <div class="data-profil">
        ...
        <input type="text" name="nama_wali"
            value="<?= htmlspecialchars($_POST['nama_wali'] ?? $data_siswa['NAMA_WALI'] ?? ''); ?>">
        <?php
    ...
    <div class="data-profil">
        ...
        <input type="text" name="nomor_telpon"
            value="<?= htmlspecialchars($_POST['nomor_telpon'] ?? $data_siswa['TELP_WALI'] ?? ''); ?>">
        <?php
    ...
    <div class="data-profil">
        ...
        <textarea name="deskripsi_kebutuhan" id="deskripsi_kebutuhan" rows="4"><?= htmlspecialchars($_POST['deskripsi_kebutuhan'] ?? $data_kebutuhan_aktif['DESKRIPSI_SISWA_KHUSUS'] ?? '') ?></textarea>
        <?php
